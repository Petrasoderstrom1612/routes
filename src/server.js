...
export function makeServer() {
    createServer({
        ...
        this.post("/login", (schema, request) => {
            ...
            if(!foundUser){
                return new Response(401, {},{ message: "No user with credentials found"})
            }
