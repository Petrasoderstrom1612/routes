...
const Authorized = () => {
    ...
    return (<Navigate to="login" state={{message: "You must log in first"}} replace={true}/>) //you do not need it in else because only one return works in a function //first curlies to get into JS second curlies for object
